        ...
        $builder->addEventListener(FormEvents::PRE_SUBMIT, function (FormEvent $event) {
            ...
            if ($fechaStr && $mesaId) {
                ...
                if ($fecha && $mesa) {
                    ...
                    $horasAlmuerzo = ['13:00', '13:15', '13:30', '13:45', '14:00', '14:15', '14:30', '14:45', '15:00', '15:15'];
                    $horasCena = ['20:00', '20:15', '20:30', '20:45', '21:00', '21:15', '21:30', '21:45', '22:00'];
                    $todasLasHoras = array_merge($horasAlmuerzo, $horasCena);
